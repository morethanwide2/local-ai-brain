...
- [Fogg Behavior Model](file:///D:/Connect AI/2. 위키에이전트/10_Wiki/💡 Topics/Psychology/Fogg Behavior Model.md) - *인간의 행동은 동기(Motivation), 능력(Ability), 계기(Trigger)가 동시에 작용할 때 발생하며, 행동 변화를 위해서는 동기 부여보다 행동을 더 쉽게 만드는 것이 효과적이다.*

## [⚖️ Decisions](file:///d:/Connect%20AI/2.%20위키에이전트/10_Wiki/⚖️%20Decisions)
*No files synthesized yet.*
